  ...
  <PagePanel>
    ...
    <template #main-table>
      <div class="list-header">
        <el-button type="primary" @click="handleAdd">+ 新增打分标准</el-button>
      </div>
    ...
    <template #modals>
      <ScoringStdAdd v-model:visible="showAddDialog" @refresh="handleRefresh"></ScoringStdAdd>
      <ScoringStdEdit v-model:visible="showEditDialog" :standardId="selectedStandardId" @refresh="handleRefresh">
      </ScoringStdEdit>
    </template>
  </PagePanel>
</template>
