<template>
  <div class="oj-recruit-page">
    ...
    <section class="section" id="intro">
      <div class="container" :class="isVisible('intro') ? 'show' : ''">
    ...
    <section class="section" id="work">
      <div class="container" :class="isVisible('work') ? 'show' : ''">
    ...
    <section class="section" id="faq">
      <div class="container" :class="isVisible('faq') ? 'show' : ''">
    ...
    <section class="section" id="plan">
      <div class="container" :class="isVisible('plan') ? 'show' : ''">
    ...
    <section class="section join-section" id="join">
      <div class="container" :class="isVisible('join') ? 'show' : ''">
...
// 滚动监听
const handleScroll = () => {
  // banner 动态 translateX：滚动时从 -200 平滑移动到 0
  const scrollTop = document.documentElement.scrollTop || document.body.scrollTop
  const max = 300
  translateXValue.value = Math.max(-200 + scrollTop * 0.8, -200)
  ...
  sections.forEach(el => {
    ...
    visibleSections.value[id] = rect.top < window.innerHeight * 0.75
  })
}
...
const isVisible = (id) => visibleSections.value[id]
